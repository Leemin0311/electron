    ...
    describe('"sandbox" option', () => {
      ...
      describe('event handling', () => {
        it('works for window events', (done) => {
          ...
          w.loadFile(path.join(fixtures, 'api', 'sandbox.html?window-events'))
        })
        ...
        it('works for stop events', (done) => {
          ...
          w.loadFile(path.join(fixtures, 'api', 'sandbox.html?webcontents-stop'))
        })
        ...
        it('works for web contents events', (done) => {
          ...
          w.loadFile(path.join(fixtures, 'api', 'sandbox.html?webcontents-events'))
        })
      })
      ...
      it('releases memory after popup is closed', (done) => {
        ...
        w.loadFile(path.join(fixtures, 'api', 'sandbox.html?allocate-memory'))
      ...
      it('properly manages remote object references after page reload', (done) => {
        ...
        w.loadFile(path.join(fixtures, 'api', 'sandbox.html?reload-remote'))
      ...
      it('properly manages remote object references after page reload in child window', (done) => {
        ...
        w.loadFile(path.join(fixtures, 'api', 'sandbox.html?reload-remote-child'))
